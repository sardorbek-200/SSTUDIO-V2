...
class SubjectHubQuestion(Base):
    __tablename__ = "subjecthubquestion"

    id = Column(Integer, primary_key=True, index=True)
    text = Column(String, nullable=False)
    options = Column(String, nullable=False) # Variantlar uchun ["A", "B", "C", "D"]
    correct_answer = Column(String, nullable=False)
    subject = Column(String, nullable=False) # Fan nomi
